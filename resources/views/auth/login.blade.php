...
<body>
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(https://athle-nemours-saint-pierre.com/wp-content/uploads/2021/02/b%C3%A9n%C3%A9volat.png);">
            <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            <div class="w-full px-24 z-10">
                <h1 class="text-5xl font-bold text-left tracking-wide">Volontariat </h1>
                <p class="text-3xl my-4"> Pour donner du sens à ses vacances</p>
            </div>
